-- Funcion para calcular el monto sin impuestos a una línea de factura.
-- Sólo válido para Westfalia, en casos que el impuesto es por línea, por ser más rápida.
-- Cuando se utilice el estándar, se deb utilizar la función original.
