...
DECLARE
  ...
  v_inventory_value_prev_year 	numeric; -- Valor Inventario año previo
  v_inventory_value_curr_year 	numeric; -- Valor Inventario año actual
  v_avg_inventory_value   		numeric; -- Valor Inventario promedio ( (Valor Inventario año previo + Valor Inventario año actual)/2 )
